import { About, Product, Contact } from '../routes/index';
import '../css/Home.css'
        ...
        <section id="home">
            <div className='container'>
                ...
                <div className='col-md-8 mt-5 content'>
                    <h1 className='display-4 fw-bolder mb-4 text-center'>Wellcome To Coffee Shop!!</h1>
                    ...
                    <div className='butons d-flex justify-content-center'>
